  ...
  switch (request.method) {
    ...
    case 'send': {
      ...
      const encryptionKeySkdeStatic =
        '';

      const decryptionKeySkdeStatic =
        '';
      ...
      console.log('cipherTextSkdeStatic', cipherTextSkdeStatic);

      const decryptedDataStatic = await decryptCipherSkde(
        skdeParamsStatic,
        cipherTextSkdeStatic,
        decryptionKeySkdeStatic,
      );

      console.log('decryptedDataStatic', decryptedDataStatic);
