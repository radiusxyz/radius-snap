...
export function prove_time_lock_puzzle(
  time_lock_puzzle_zkp_param: any,
  time_lock_puzzle_zkp_proving_key: any,
  time_lock_puzzle_public_input: any,
  time_lock_puzzle_secret_input: any,
  time_lock_puzzle_param: any,
): any;
/**
 * @param {any} time_lock_puzzle_zkp_param
...
export function verify_time_lock_puzzle_proof(
  time_lock_puzzle_zkp_param: any,
  time_lock_puzzle_zkp_verifying_key: any,
  time_lock_puzzle_public_input: any,
  time_lock_puzzle_param: any,
  time_lock_puzzle_proof: any,
): boolean;
/**
 * @param {any} o
 * @param {any} t
...
export function prove_encryption(
  param: any,
  proving_key: any,
  encryption_public_input: any,
  encryption_secret_input: any,
): any;
/**
 * @param {any} param
...
export interface InitOutput {
  ...
  readonly prove_time_lock_puzzle: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly verify_time_lock_puzzle_proof: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly prove_encryption: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => number;
  readonly verify_encryption_proof: (
    a: number,
    b: number,
    c: number,
    d: number,
